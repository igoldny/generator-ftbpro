...
SpecGenerator.prototype.files = function files() {
  if (this.options.collections) {
    ...
    return this.copy('spec_view_model_collections.js.coffee', 'spec/javascripts/singlepage/views/' + this.underscored_name + '_spec.js.coffee');
  }

  if (this.options.model) {
    this.copy('spec_model.js.coffee', 'spec/javascripts/singlepage/models/' + this.underscored_name + '_spec.js.coffee');
    return this.copy('spec_view_model.js.coffee', 'spec/javascripts/singlepage/views/' + this.underscored_name + '_spec.js.coffee');
  }

  if (this.options.hash) {
    return this.copy('spec_view_hash.js.coffee', 'spec/javascripts/singlepage/views/' + this.underscored_name + '_spec.js.coffee');
  }
